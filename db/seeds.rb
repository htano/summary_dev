...
Summary.create(content: "summary id 8 test", user_id: 4, article_id: 1)
Summary.create(content: "summary id 9 test", user_id: 5, article_id: 1)
Summary.create(content: "summary id 10test", user_id: 6, article_id: 1)
Summary.create(content: "summary id 11test", user_id: 7, article_id: 1)
Summary.create(content: "summary id 8 test", user_id: 8, article_id: 1)
Summary.create(content: "summary id 9 test", user_id: 9, article_id: 1)
Summary.create(content: "summary id 10test", user_id: 10, article_id: 1)
Summary.create(content: "summary id 11test", user_id: 11, article_id: 1)
# GoodSummary
