...
class Article < ActiveRecord::Base
  ...
  DAYS_OF_HOTENTRY = 3
  DAYS_OF_CATEGORY_HOTENTRY = 14
  DAYS_OF_PERSONAL_HOTENTRY = 28
  ZERO_ZERO_ONE_DAYS = 14
  DECAY_DELTA = 0.01**(1.0/(24*ZERO_ZERO_ONE_DAYS))
  HOTENTRY_CANDIDATE_NUM = 300
  PERSONAL_HOTENTRY_CANDIDATE_NUM = 300
  HOTENTRY_DISPLAY_NUM_SMALL = 40
  HOTENTRY_DISPLAY_NUM_NORMAL = 20
  HOTENTRY_DISPLAY_NUM_LARGE = 10
