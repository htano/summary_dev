...
svmdata <- read.matrix.csr("tmp/auto_summarize/learning/train_data_20131113.txt"); # auto labeling by make_liblinear
tr.num <- 1:as.integer(svmdata$x@dimension[1] * 0.9)
...
write(attr(s,"scaled:center"), file="lib/auto-summary/params/feature_center.txt", sep="\n")
write(attr(s,"scaled:scale"), file="lib/auto-summary/params/feature_scale.txt", sep="\n")
write(m$W, file="lib/auto-summary/params/feature_weight.txt", sep="\n")
